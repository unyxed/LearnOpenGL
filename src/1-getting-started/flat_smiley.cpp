...
int main() {
    ...
    // shader
    Shader flat_smiley_shader(
        RESOURCE_DIR "shaders/1-getting-started/flat_smiley.vert",
        RESOURCE_DIR "shaders/1-getting-started/flat_smiley.frag"
    );

    // activating our shader
    flat_smiley_shader.use();
    ...
    unsigned int u_texture1 = glGetUniformLocation(flat_smiley_shader.shader_program, "texture1");
    unsigned int u_texture2 = glGetUniformLocation(flat_smiley_shader.shader_program, "texture2");
