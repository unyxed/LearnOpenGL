...
int main() {
	...
	Shader lightingShader(
		RESOURCE_DIR "shaders/2_lighting/colors_vertex.vert",
		RESOURCE_DIR "shaders/2_lighting/colors_fragment.frag"
	);

	/*
		Shader lightCubeShader(
		RESOURCE_DIR "shaders/2_lighting/light_cube_vertex.vert",
		RESOURCE_DIR "shaders/2_lighting/light_cube_fragment.frag"
		);
	*/
